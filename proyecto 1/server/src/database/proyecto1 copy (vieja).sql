...
CREATE TABLE public."Venta" (
    id integer NOT NULL,
    monto real NOT NULL,
    "asistenciaFecha" date,
    "asistenciaEmpleadoId" integer,
    "clienteId" integer
);
...
COPY public."Hist_Salarios" ("numContrato", "sueldoQuinc", "fechaIni", "fechaFin", "empleadoId") FROM stdin;
\.
...
COPY public."Hist_Venta" (fecha, "cantVend", "ventaId", "inventarioId") FROM stdin;
\.
...
COPY public."Venta" (id, monto, "asistenciaFecha", "asistenciaEmpleadoId", "clienteId") FROM stdin;
\.
...
ALTER TABLE ONLY public."Hist_Venta"
    ADD CONSTRAINT "PK_0aee21ff2b48773503ebe400e3d" PRIMARY KEY (fecha, "ventaId", "inventarioId");
