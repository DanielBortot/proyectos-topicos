...
export class PruebaRela21697720350243 implements MigrationInterface {
    name = 'PruebaRela21697720350243'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Tabla1" ("id" SERIAL NOT NULL, "msg" text NOT NULL, CONSTRAINT "PK_b616b1e9a8460a1bad5daae36cb" PRIMARY KEY ("id"))`);
